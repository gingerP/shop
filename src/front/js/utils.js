...
var U = {
    ...
    /*if (U.isIE()) {*/
        ...
        shadowTop.setAttribute('class', 'shadow_top');
        var shadowRight = document.createElement('DIV');
        shadowRight.setAttribute('class', 'shadow_right');
        var shadowBottom = document.createElement('DIV');
        shadowBottom.setAttribute('class', 'shadow_bottom');
        var shadowLeft = document.createElement('DIV');
        shadowLeft.setAttribute('class', 'shadow_left');
        mainDiv.appendChild(shadowTop);
        mainDiv.appendChild(shadowRight);
        mainDiv.appendChild(shadowBottom);
        mainDiv.appendChild(shadowLeft);
    /*}*/
    },
