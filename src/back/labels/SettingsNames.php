...
class SettingsNames
{
    ...
    const DROPBOX_API_KEY = 'DROPBOX_API_KEY';
    const DROPBOX_API_SECRET = 'DROPBOX_API_SECRET';
    ...
    const JWT_EXPIRES_IN = 'jwt_admin_expires_in';
    const JWT_REFRESH_TOKEN_EXPIRES_IN = 'jwt_refresh_token_expires_in';
}