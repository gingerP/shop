    ...
    public function getPaginationLinks($pageNumber, $num, $totalCount, $topBottom) {
        ...
        if ($totalCount != 0) {
            ...
            if ($pageNumber > 0 && $pageNumber <= $amountPages) {
                ...
                if ($pageNumber != 1) {
                    $tagPrevious = new A();
                    $tagPrevious->addStyleClasses(["f-16", "text_non_select", "link_style", "link_next_prev", "input_hover", "prev_link", "pagination-item"]);
                ...
                if ($pageNumber != $amountPages) {
                    $tagNext = new A();
                    $tagNext->addStyleClasses(["f-16", "text_non_select", "link_style", "input_hover", "link_next_prev", "next_link", "pagination-item"]);
