...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .background-color {
      background-color: rgba(15, 166, 141, 1) !important;
    }
    ...
    .border-button {
      color: rgba(236, 177, 75, 1) !important;
      border-color: rgba(236, 177, 75, 1) !important;
    }
    .button {
      background-color: rgba(236, 177, 75, 1) !important;
      color: #FFFFFF !important;
    }
  ...
  <body class="plain error-page-wrapper background-color background-image">
	...
	<div class="buttons-container">
		<a class="border-button" href="http://augustova.by" target="_blank">Go To Homepage</a>
    ...
    <script>
      function ErrorPage(e,t,n){
          this.$container=$(e),
          this.$contentContainer=this.$container.find(n=="sign"?".sign-container":".content-container"),
          this.pageType=t,
          this.templateName=n
      }
      ErrorPage.prototype.centerContent=function(){
          ...
          n=(e-t)/2,r=this.templateName=="sign"?-100:0;this.$contentContainer.css("top",n+r)
      },
      ErrorPage.prototype.initialize=function(){
          var e=this;
          this.centerContent(),
          this.$container.on("resize",function(t){t.preventDefault(),t.stopPropagation(),e.centerContent()}),
          this.templateName=="plain"&&window.setTimeout(function(){e.$contentContainer.addClass("in")},500),
          this.templateName=="sign"&&$(".sign-container").animate({textIndent:0},{step:function(e){$(this).css({transform:"rotate("+e+"deg)","transform-origin":"top center"})},duration:1e3,easing:"easeOutBounce"})
      },
      ...
      ErrorPage.prototype.handleStatusFetchSuccess=function(e,t){
          ...
          else{var n=t.scheduled_maintenances[0];$("#replace-with-fetched-data").html(this.createTimeRangeTag(n.scheduled_for,n.scheduled_until)),$.fn.localizeTime()}
      },
      ...
      ErrorPage.prototype.fetchStatus=function(e,t){
          if(!e||!t||t=="404")return;
          var n="",r=this;
          t=="503"?n=e+"/api/v2/status.json":n=e+"/api/v2/scheduled-maintenances/active.json",
          $.ajax({type:"GET",url:n}).success(function(e,n){r.handleStatusFetchSuccess(t,e)}).fail(function(e,n){r.handleStatusFetchFail(t)})
      };
